...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="<?= base_url('coordinador') ?>" class="brand-link text-center">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <!-- <li class="nav-item menu-open">
                        <a href="<?= site_url('coordinador/horario'); ?>" class="nav-link active">
                    ...
                    <li class="nav-item menu-open">
                        <a href="<?= site_url('coordinador/programacion'); ?>" class="nav-link active">
                        <i class="nav-icon fas fa-square-poll-horizontal"></i>
                            <p>Programación</p>
                        </a>
...
<!--                    </li>-->
                    ...
                    <li class="nav-item">
                        <a href="<?= site_url('coordinador/asignaturas'); ?>" class="nav-link">
