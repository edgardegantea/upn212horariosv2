    ...
    <article class="mt-5 mb-3">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="licenciatura_cedula" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input class="" type="file" name="maestria_cedula" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="doctorado_cedula" accept=".pdf, image/*">
            </div>
    ...
    <article class="mt-5 mb-3">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_articulo1" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_articulo2" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_articulo3" accept=".pdf, image/*">
            </div>
    ...
    <article class="mt-5 mb-3">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_curso1" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_curso2" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_curso3" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_curso4" accept=".pdf, image/*">
            </div>
    ...
    <article class="mt-5 mb-3">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_ponencia1" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_ponencia2" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_ponencia3" accept=".pdf, image/*">
            </div>
    ...
    <article class="mt-5 mb-3">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_cert1" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_cert2" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_cert3" accept=".pdf, image/*">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="file" name="evidencia_cert4" accept=".pdf, image/*">
            </div>
